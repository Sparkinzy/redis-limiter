 ...
 */
namespace Mu\Juyuan;
use Mu\Juyuan\Parser;
use Mu\Juyuan\RedisLimter;
class Limit{
	 ...
	 * @return Limit|null
	 */
	public function setMax($rate='1r/s')
	{
	...
	public static function isAllow($limit_id='')
	{
		...
		RedisLimter::init(self::$redis_conf);
		return RedisLimter::isAllow($limit_id,$rate_rule['limit_count'],$rate_rule['limit_cycle']);
	}
